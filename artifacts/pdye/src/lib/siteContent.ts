...
export const SITE_DEFAULTS: Record<string, Record<string, Record<string, string>>> = {
  ...
  owners: {
    ...
    benefits: {
      ...
      item4_desc: "CNCA-protected introductions, escrow management, and full legal documentation handled by our maritime experts.",
    },
    process: {
      tag: "The Process",
    ...
    form: {
      ...
      desc: "All submissions are protected by CNCA. Our team will respond within 48 hours.",
      submit_btn: "Submit Confidentially",
      disclaimer: "Protected by CNCA · All enquiries handled with absolute discretion",
  ...
  buyers: {
    ...
    benefits: {
      ...
      item2_desc: "Exclusive access to our secure deal room with full financial documentation, surveys, and valuation reports under CNCA.",
    ...
    form: {
      ...
      disclaimer: "All information is kept strictly confidential under CNCA.",
      success_title: "Application Received",
