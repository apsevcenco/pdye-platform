...
export const SITE_DEFAULTS: Record<string, Record<string, Record<string, string>>> = {
  home: {
    ...
    expertise: {
      ...
      item2_title: "Boat Owner Network",
      item2_desc: "Vetted database of yacht owners ready to list and transact confidentially.",
  ...
  buyers: {
    hero: {
      tag: "Boat Owner Services",
      title: "Sell Your Yacht <span class=\"text-primary\">Privately</span><br />& Confidentially",
      desc: "PDYE connects boat owners with qualified buyers through our exclusive private network — discreetly, efficiently, and at optimal valuations.",
      badge1: "Private Owners",
      badge2: "Fleet Operators",
      badge3: "Estate Managers",
      badge4: "Corporate Owners",
    },
    stats: {
      stat1_val: "€2.4B+",
    ...
    benefits: {
      title: "Why Boat Owners Choose PDYE",
      subtitle: "Discreet, professional yacht sales for private owners",
      item1_title: "Confidential Listings",
      item1_desc: "Your vessel is presented exclusively to pre-qualified buyers — never on public marketplaces. Complete discretion guaranteed.",
      item2_title: "Private Deal Room",
      item2_desc: "Secure deal room with full documentation, surveys, and valuation reports shared only under NDA with verified buyers.",
      item3_title: "Global Buyer Network",
      item3_desc: "Access to qualified buyers across Mediterranean, Caribbean, and Asia-Pacific markets through our vetted network.",
      item4_title: "Dedicated Representation",
      item4_desc: "Personal account management from listing to closing. We handle negotiations, documentation, and transaction structuring.",
    },
    form: {
      tag: "List Your Vessel",
      title: "Boat Owner Application",
      desc: "Submit your vessel details. Our team reviews each application within 48 hours.",
      submit_btn: "Submit Application",
      disclaimer: "All information is kept strictly confidential under NDA.",
      success_title: "Application Received",
      success_desc: "Our team will review your vessel details and contact you within 48 hours to discuss listing and set up your private access.",
    },
  },
  access: {
    owner: {
      tag: "Boat Owner Services",
      heading: "List Your<br />Yacht",
      sub: "Sell your vessel privately through our exclusive network of qualified buyers and trusted brokers.",
      note: "All listings are subject to verification and approval.",
      stat1_num: "€2.4B+",
      stat1_label: "Transactions facilitated",
      stat2_num: "200+",
      stat2_label: "Qualified buyers in network",
      stat3_num: "48h",
      stat3_label: "Listing review time",
    },
    broker: {
      tag: "Broker Partnership",
