...
By accepting below, the Receiving Party acknowledges having read, understood, and agreed to be bound by this Agreement.`;

export const TERMS_TEXT = `TERMS OF ACCESS & NON-CIRCUMVENTION

By accepting these Terms, you agree to the following conditions governing your access to the PDYE Deal Room:
