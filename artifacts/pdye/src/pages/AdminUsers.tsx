...
import { CheckCircle, Clock, Users, RefreshCw } from "lucide-react";
      ...
      <div className="min-h-screen bg-background pt-8 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between gap-4 mb-8 flex-wrap">
            ...
            <button
              onClick={load}
              className="flex items-center gap-2 text-white/40 hover:text-primary transition-colors text-sm font-sans"
            >
              <RefreshCw size={13} />
              Refresh
            </button>
